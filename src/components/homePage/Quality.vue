<template>
  <div class="quality-fiture py-12 bg-grey-lighten-3">
          ...
          <v-hover v-slot="{ isHovering, props }">
            ...
            >
              <div>
                ...
                >
                <v-card-text>{{ card.disc }}</v-card-text>
              </div>
            </v-card>
          </v-hover>
        </v-col>
